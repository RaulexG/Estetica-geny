    ...
    <div className="p-8 bg-gray-50 rounded-lg">
      ...
      <form className="bg-gray-100 p-8 rounded-b-lg space-y-6">
        ...
        <div className="flex items-center space-x-4">
          ...
          <button type="button" className="bg-gray-400 text-white px-4 py-2 rounded-lg">Agregar imagen</button>
        </div>

        <button type="submit" className="bg-gray-500 text-white w-full py-3 rounded-lg">Agregar</button>
      </form>
    </div>
  );
}
